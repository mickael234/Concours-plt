      ...
      <div className="footer-content">
        <div className="footer-section">
          ...
          <p className="footer-description">
            ...
            ambitieux et aligné avec ses aspirations.
          </p>
        ...
        <div className="footer-section">
          <h3>La plateforme</h3>
          <ul>
            <li><Link to="/avis-concours">Avis sur les concours</Link></li>
            <li><Link to="/avis-etablissements">Avis sur les établissements</Link></li>
            <li><Link to="/concours">Liste concours lancés</Link></li>
          </ul>
        </div>
        ...
        <div className="footer-section">
          ...
          <ul>
            <li><Link to="/candidats">Candidats et futurs candidats</Link></li>
            <li><Link to="/formateurs">Les formateurs aux concours</Link></li>
            <li><Link to="/organisateurs">Les organisateurs de concours</Link></li>
          </ul>
        </div>
      </div>
